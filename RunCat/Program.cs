    ...
    public class RunCatApplicationContext : ApplicationContext
    {
        ...
        public RunCatApplicationContext()
        {
            ...
            runnerMenu = new ToolStripMenuItem("Runner", null, new ToolStripMenuItem[]
            {
                ...
                new ToolStripMenuItem("flower", null, SetRunner)
                {
                    Checked = runner.Equals("flower")
                },
                new ToolStripMenuItem("kickstone", null, SetRunner)
                {
                    Checked = runner.Equals("kickstone")
                },
                new ToolStripMenuItem("cat2", null, SetRunner)
                {
                    Checked = runner.Equals("cat2")
                },
                new ToolStripMenuItem("colorfulcat", null, SetRunner)
                {
                    Checked = runner.Equals("colorfulcat")
                },
                new ToolStripMenuItem("slime", null, SetRunner)
                {
                    Checked = runner.Equals("slime")
                },
                new ToolStripMenuItem("hios", null, SetRunner)
                {
                    Checked = runner.Equals("hios")
                }
            });
        ...
        private void SetIcons()
        {
            ...
            int capacity = 0;
            if(runner.Equals("cat")) capacity = 5;
            else if(runner.Equals("parrot")) capacity = 10;
            else if(runner.Equals("flower")) capacity = 10;
            else if(runner.Equals("kickstone")) capacity = 5;
            else if(runner.Equals("cat2")) capacity = 13;
            else if(runner.Equals("colorfulcat")) capacity = 26;
            else if(runner.Equals("slime")) capacity = 9;
            else if(runner.Equals("hios")) capacity = 3;
